    ...
    import com.example.p2.ml.Model;
...
//        }
        ...
        public void classifyImage(Bitmap image){
            try {
                ...
                if(maxConfidence < 0.6) { // If confidence is less than 0.5
                    result.setText("Not a medicinal plant");
                } else { // If confidence is 0.5 or more
                    result.setText(classes[maxPos] + " with confidence: " + maxConfidence);
                }
